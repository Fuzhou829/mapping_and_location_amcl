 ...
 * @Version: 1.0
 * @Date: 2022-10-01 16:31:16
 * @LastEditTime: 2022-11-09 22:44:49
 */
/*
...
void SpaSolver::Clear() { corrections.clear(); }
...
void SpaSolver::Compute() {
  ...
  typedef std::vector<sba::Node2d, Eigen::aligned_allocator<sba::Node2d> >
      NodeVector;
